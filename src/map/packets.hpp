...
struct PACKET_CZ_UNCONFIRMED_UNEQUIPALL{
	int16 packetType;
};
...
// NetBSD 5 and Solaris don't like pragma pack but accept the packed attribute
	...
	#pragma pack( pop )
#endif
DEFINE_PACKET_HEADER(HEADER_CZ_GRADE_ADD_ITEM,0x0b59)
DEFINE_PACKET_HEADER(HEADER_CZ_GRADE_START,0x0b5b)
DEFINE_PACKET_HEADER(HEADER_CZ_GRADE_Close,0x0b5c)
...
DEFINE_PACKET_HEADER(CZ_UNCONFIRMED_UNEQUIPALL, 0xbad)
